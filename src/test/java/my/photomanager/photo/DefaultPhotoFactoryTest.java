...
class DefaultPhotoFactoryTest {
    ...
    void shouldCreatePhotoObjectOfPhotoFileWithExifData(File photoFile) throws IOException {
        var photo = photoFactory.createPhoto(photoFile);
    ...
    void shouldCreatePhotoObjectOfPhotoFileWithoutExifData(File photoFile) throws IOException {
        var photo = photoFactory.createPhoto(photoFile);
        ...
        assertThat(photo.getRoad()).isEmpty();
    }
}
